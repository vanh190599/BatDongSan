<%@ Page Title="" Language="C#" MasterPageFile="~/FRONTEND/Layout-2.Master" AutoEventWireup="true" CodeBehind="DangTin.aspx.cs" Inherits="GiaoDien.FRONTEND.DangTin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-2">
            <img src="../assets/frontend/adv2.jpg" style="margin-left: 60px" />
        </div>
        <div class="col-lg-8">
            <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div style="border: 1px solid #dddddd; background: white; padding: 18px; border-radius: 5px; font-size: 14px;">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNguoiDang" readonly="true" CssClass="form-control" value="" runat="server"></asp:TextBox>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtLienHe" ReadOnly="true" CssClass="form-control"  runat="server"></asp:TextBox>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <span class="font-weight-bold" style="font-size: 20px; color: gray"><i>&nbsp;  Chờ phê duyệt bài đăng...</i></span>
                    </div>

                    <div class="text-center">
                        <asp:Button ID="Submit" CssClass="btn btn-primary text-light" runat="server" Text="Submit" OnClick="Submit_Click"  />
