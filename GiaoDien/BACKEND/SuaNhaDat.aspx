<%@ Page Title="" Language="C#" MasterPageFile="~/BACKEND/Layout.Master" AutoEventWireup="true" CodeBehind="SuaNhaDat.aspx.cs" Inherits="GiaoDien.BACKEND.SuaNhaDat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <style>
        ...
        .image1{
            width: 140px; height: 100px; border-radius: 5px; margin-bottom: 5px;
        }
        .auto-style1 {
            text-align: center;
            font-size: 11pt;
        ...
        <div class="card-body d-flex justify-content-center">
            <div class="col-lg-9">
                <div class="text-center text-primary">
                    <h3> <i class="fas fa-home"></i>&nbsp; SỬA NHÀ ĐẤT BÁN</h3>
                </div>
                ...
                <div style="border: 1px solid #dddddd; background: white; padding: 18px; border-radius: 5px; font-size: 14px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div style="margin-top: 5px;">
                                    <asp:Image ID="Image1" CssClass="image1" runat="server" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div style="margin-top: 5px;">
                                    <asp:Image ID="Image2" CssClass="image1" runat="server" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <div style="margin-top: 5px;">
                                    <asp:Image ID="Image3" CssClass="image1" runat="server" />
                    ...
                    <div class="form-group">
                        <asp:CheckBox ID="checkStatus" CssClass="Duyet" runat="server"  />
